# Generated by Django 3.0 on 2022-03-26 14:16
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('phone_no', models.CharField(max_length=10, unique=True, validators=[django.core.validators.RegexValidator(message="Mobile number must be 10 digits starting with '05'.", regex='^05\\d{8}$')], verbose_name='Mobile Number')),
